...
module Pairing_bls12381 (g1Point, g2Point, g1Generator, g2Generator, pointMul, pointAdd,
                         pairing, fieldPrime, groupOrder, smokeTest, Num( (*) ), Point (..), Fq1(..), Fq2(..), Fq6(..), Fq12(..), untwist ) where
...
miller p q = miller' p q (pointNegate q) iterations 1
...
iterations' :: [Integer]
iterations' = tail $ -- list of true/false per bits of operand
  unfoldr (\b -> if b == (0 :: Integer) then Nothing
                  else Just(if odd b then 1 else 0, shiftR b 1)) 0xf0
...
testVector :: Maybe Fq12
testVector = pairing
  (Affine (Fq1 0x17f1d3a73197d7942695638c4fa9ac0fc3688c4f9774b905a14e3a3f171bac586c55e83ff97a1aeffb3af00adb22c6bb)
    (Fq1 0x08b3f481e3aaa0f1a09e30ed741d8ae4fcf5e095d5d00af600db18cb2c04b3edd03cc744a2888ae40caa232946c5e7e1))
  (Affine (Fq2 (Fq1 0x13e02b6052719f607dacd3a088274f65596bd0d09920b61ab5da61bbdc7f5049334cf11213945d57e5ac7d055d042b7e)
    (Fq1 0x024aa2b2f08f0a91260805272dc51051c6e47ad4fa403b02b4510b647ae3d1770bac0326a805bbefd48056c8c121bdb8))
    (Fq2 (Fq1 0x0606c4a02ea734cc32acd2b02bc28b99cb3e287e85a763af267492ab572e99ab3f370d275cec1da1aaa9075ff05f79be)
    (Fq1 0x0ce5d527727d6e118cc9cdc6da2e351aadfd9baa8cbdd3a76d429a695160d12c923ac9cc3baca289e193548608b82801)))
...
showe0 :: String
showe0 = e0 $ fromJust testVector

showe1 :: String
showe1 = e1 $ fromJust testVector

showe2 :: String
showe2 = e2 $ fromJust testVector

showe3 :: String
showe3 = e3 $ fromJust testVector

showe4 :: String
showe4 = e4 $ fromJust testVector

showe5 :: String
showe5 = e5 $ fromJust testVector

showe6 :: String
showe6 = e6 $ fromJust testVector

showe7 :: String
showe7 = e7 $ fromJust testVector

showe8 :: String
showe8 = e8 $ fromJust testVector

showe9 :: String
showe9 = e9 $ fromJust testVector

showe10 :: String
showe10 = e10 $ fromJust testVector

showe11 :: String
showe11 = e11 $ fromJust testVector
