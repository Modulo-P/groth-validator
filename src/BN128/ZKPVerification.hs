...
module BN128.ZKPVerification where
...
mkWrappedValidator = Utilities.wrapValidator mkVerificationValidator

grothValidator :: PlutusV2.Validator
grothValidator = PlutusV2.mkValidatorScript $$(compile [|| mkWrappedValidator ||])
